...
print(step_control.open())

print('encoder value',step_control.readEncoderValue())
print('Pulse received',step_control.readReceivedPulses())
print('Motor angle',step_control.readMotorShaftAngle())
print('error',step_control.readMotorShaftErrorAngle())
print('en pin',step_control.readEnPinStatus())
print('shaft status',step_control.readShaftStatus())

print('En pin',step_control.setEnablePin(False))
print('En pin',step_control.setEnablePin(True))


# print('max rpm',step_control.calSpeedRPM(127))

# # #print(step_control.setMotorRelativePose(100,-6400))
# # #time.sleep(5)
# # #step_control.stopMotor()
# # #step_control.setMotorRelativePose(100,3200)

# # print('Pulse received',step_control.readReceivedPulses())

# #print(step_control.setZero(step=100,rpm=50))

# step_control.setMotorAbsolutePose(800,-38000)

# print(step_control.close())
